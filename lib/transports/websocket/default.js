...
WebSocket.prototype.onSocketConnect = function () {
  ...
  if(this.manager.settings['force origin protocol']){
    location = this.manager.settings['force origin protocol'] + '://' + this.req.headers.host + this.req.url;
  } else if(this.manager.settings['match origin protocol']){
